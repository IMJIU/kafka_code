...
class LogSegment(val log: FileMessageSet, 
   ...
   */
  /*
read(startOffset: Long, maxOffset: Option[Long], maxSize: Int): FetchDataInfo
  translateOffset(offset: Long, startingFilePosition: Int = 0): OffsetPosition
  {
    OffIndex
    {lookup(targetOffset: Long): OffsetPosition
          indexSlotFor(idx: ByteBuffer, targetOffset: Long): Int
    }
    FileMessageSet{searchFor(targetOffset: Long, startingPosition: Int): OffsetPosition}
  }
